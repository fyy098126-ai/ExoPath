...
# Compatibility alias for loaders following the upstream class-name
# convention.  Both names reference the exact same implementation and state
# dictionary; no forward or training logic is changed.
TQNet = Model
